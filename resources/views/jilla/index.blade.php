            ...
            <table id="kt_customers_table" class="table align-middle table-row-dashed fs-6 gy-5">
                <thead>
                    <tr class="text-start fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-center">{{ trans('messages.jilla.fields.prant') }}</th>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input name="id[]" class="form-check-input checkbox selectAllCheckbox"
                                        type="checkbox" value="{{ $districts->id }}" />
                                </div>
                            </td>
                            <td class="text-center">{{ $loop->iteration }}</td>
                            <td class="text-center">{{ $districts->name }}</td>
                            <td class="text-center">{{ $districts->prant_name ?? '' }}</td>
                            ...
                            <td class="text-center">
                                <span class="btn btn-info" style="width: 60px;" data-bs-toggle="tooltip"
                                    ...
                                    title="{{ $districts->concat_values }}"><i class="fa fa-info"></i></span>
                                <a href="javascript:void(0);" data-toggle="tooltip" data-bs-custom-class="tooltip-dark"
                                    {{ $districts->status == '1' ? 'title= Active' : 'title=Inactive' }}
                                    onclick="changeJillaStatus('{{ $districts->status }}','{{ $districts->id }}')"
                                ...
                                <a href="{{ route('jilla.show', [$districts->id]) }}" data-toggle="tooltip"
                                    data-bs-custom-class="tooltip-dark" title="Show" class="btn btn-xs btn-primary"><i
                                        class="fa fa-eye"></i></a>
                                <a href="{{ route('jilla.edit', [$districts->id]) }}" data-toggle="tooltip"
