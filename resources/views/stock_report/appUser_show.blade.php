    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center mt-2">
                <h5 class="text-start fw-bolder text-uppercase gs-0">{{ $gramName }} > </h5>
                <h5 class="text-start fw-bolder text-uppercase gs-0">{{ $medicineName }}</h5>
            </div>
        </div>
    </div>

    {!! Form::open(['route' => ['report.appUser-show', $mId, $gramId], 'method' => 'POST', 'class' => 'row row-cols-lg-auto g-3 align-items-center', 'autocomplete' => 'off']) !!}
    @csrf
    <div class="card-header border-0 pt-2">
        <div class="card-title">
            <div class="d-flex align-items-center ms-2">
                ...
                <a href="{{ route('report.appUser-show', [$mId, $gramId]) }}" class="btn btn-light ms-2">Reset</a>
                {!! Form::close() !!}
            </div>
    ...
    <div class="card-body pt-0 table-responsive">
            ...
            <table id="kt_customers_table" class="table align-middle table-row-dashed fs-6 gy-5 w-10px pe-2">
                ...
                <tbody class="text-gray-600 fw-bold">
                    @forelse($medicineTrack as $medicine)
                        <tr>
